...
Como estudiante del programa **ONE - Oracle Next Education**, completé este proyecto como parte de mi aprendizaje en desarrollo web. Este desafío consiste en una aplicación que permite a los usuarios ingresar nombres de amigos en una lista, realizar un sorteo aleatorio y determinar quién es el **"Amigo Secreto"**. A través de este proyecto, puse en práctica mis habilidades en HTML, CSS y JavaScript para mejorar mi lógica de programación y capacidad de resolución de problemas.
...
Este proyecto forma parte del programa **ONE - Oracle Next Education**, una iniciativa que me ha permitido fortalecer mis conocimientos en desarrollo web y lógica de programación.
